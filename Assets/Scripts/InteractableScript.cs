        ...
        if (WhatToDo == "Break") {
            ...
            if (Variables.x == 1f) {
                ...
                if (Variables.y <= 0f) {
                    ...
                    if (Variables.z == 1f) {
                        ...
                        ItemsToSpawn = new string[]{ GS.GetComponent<GameScript>().ReceiveItemVariables(Random.Range(1f, 20f)), GS.GetComponent<GameScript>().ReceiveItemVariables(Random.Range(1f, 20f)), GS.GetComponent<GameScript>().ReceiveItemVariables(Random.Range(1f, 20f)) };//new Vector3[] { GS.GetComponent<GameScript>().ReceiveItemVariables(Random.Range(1f, 20f)), GS.GetComponent<GameScript>().ReceiveItemVariables(Random.Range(1f, 20f)), GS.GetComponent<GameScript>().ReceiveItemVariables(Random.Range(1f, 20f)) };
            ...
            if (Variables.y >= 0f) {
                ...
                if (PickedObject.name == "Ammunition") {
                    ...
                    DropItem.GetComponent<ItemScript>().Variables = GS.GetComponent<GameScript>().ReceiveItemVariables(int.Parse(PickedObject.name.Substring(4)));
                }
            } else {
                SelectedModel.transform.GetChild(0).gameObject.SetActive(false);
            }
